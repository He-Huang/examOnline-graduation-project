  ...
  <div class="add">
    <el-tabs v-model="activeName">
      <el-tab-pane name="first">
        <span slot="label">
          <i class="el-icon-circle-plus"></i>添加试题
        </span>
        <section class="append">
          <ul>
            ...
            <li v-if="optionValue == '选择题'">
              ...
              <span>题目所占分值:</span>
              <el-input placeholder="请输入题目所占分值" v-model="postChange.score" class="w150"></el-input>
            </li>
            <li v-if="optionValue == '填空题'">
              ...
              <span>题目所占分值:</span>
              <el-input placeholder="请输入题目所占分值" v-model="postFill.score" class="w150"></el-input>
            </li>
            <li v-if="optionValue == '判断题'">
              ...
              <span>题目所占分值:</span>
              <el-input placeholder="请输入题目所占分值" v-model="postJudge.score" class="w150"></el-input>
            </li>
            ...
            <div class="options">
              <ul>
                <li>
                  ...
                  <el-input placeholder="请输入选项A的内容" v-model="postChange.answerA" clearable></el-input>
                </li>
                <li>
                  <el-tag type="success">B</el-tag>
                  <el-input placeholder="请输入选项B的内容" v-model="postChange.answerB" clearable></el-input>
                </li>
                <li>
                  <el-tag type="success">C</el-tag>
                  <el-input placeholder="请输入选项C的内容" v-model="postChange.answerC" clearable></el-input>
                </li>
                <li>
                  <el-tag type="success">D</el-tag>
                  <el-input placeholder="请输入选项D的内容" v-model="postChange.answerD" clearable></el-input>
                </li>
              </ul>
            </div>
            <div class="title">
